...
namespace Core {
    ...
    public class EquationBalancer {
        ...
        public boolean checkBalance() {
            Dictionary<String, Integer> atomReactant = new Dictionary<String, Integer>();
            Dictionary<String, Integer> atomProduct = new Dictionary<String, Integer>();

            foreach (Pair<Formula, Integer> pair in this.equInner.reactant) {
                foreach (Map.Entry<String, Integer> entry in pair.getL().mapAtomList.entrySet()) {
                    int numTodo = 0;
                    try {
            ...
            foreach (Pair<Formula, Integer> pair in this.equInner.product) {
                foreach (Map.Entry<String, Integer> entry in pair.getL().mapAtomList.entrySet()) {
                    int numTodo = 0;
                    try {
            ...
            foreach (Map.Entry<String, Integer> entry in atomReactant.entrySet()) {
        ...
        public boolean balanceGaussian() {
            ...
            // 原子类型表
            Map<String, Integer> mapAtom = new Dictionary<String, Integer>();
            ...
            // 给原子类型编号，顺便得到总行数
            foreach (Map.Entry<String, Integer> entry in mapAtom.entrySet()) {
            ...
            int col = 0;        // 当前的行号
            foreach (Pair<Formula, Integer> pair in this.equInner.reactant) {
                foreach (Map.Entry<String, Integer> atomPair in pair.getL().mapAtomList.entrySet()) {
        ...
        private boolean checkElementBalance() {
            // 反应物、生成物原子种类表
            Map<String, Boolean> map = new Dictionary<String, Boolean>();
            foreach (Pair<Formula, Integer> pair in this.equInner.reactant) {
                foreach (Map.Entry<String, Integer> atomPair in pair.getL().mapAtomList.entrySet()) {
            ...
            foreach (Map.Entry<String, Boolean> entry in map.entrySet()) {
